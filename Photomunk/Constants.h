...
#define FM_NETWORK_ERROR @"Photomunk has encountered a network error. Please check your network connection and try again."
...
// App Delegate Macro
#define APP_DELEGATE ((PhotomunkAppDelegate *)[[UIApplication sharedApplication] delegate])
